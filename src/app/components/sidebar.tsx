...
>(function Sidebar({ className, ...props }, outerRef) {
  return (
    <aside
      ref={outerRef}
      id="sidebar"
      ...
      className={classNames(
        'flex flex-col gap-3 p-2' /* layout */,
    ...
    >
      <header className="flex flex-col gap-4">
        <Image
          src={'/img/icon.jpg'}
          alt="Logo de um esquilo em tons de roxo produzido por inteligência artificial"
          width={300}
          height={300}
          className={classNames(
            'h-72 w-72' /* sizing */,
        ...
        <menu
          className={classNames(
            'mx-auto' /* positioning */,
            'flex flex-wrap items-center justify-center justify-items-center gap-2' /* layout */,
            'text-4xl' /* styling */
          )}
        >
          <li>
