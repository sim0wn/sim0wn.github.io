...
const TabsList = React.forwardRef<
  ...
  ClassNameProp & React.ComponentPropsWithoutRef<typeof TabsPrimitive.List>
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
...
const TabsTrigger = React.forwardRef<
  ...
  ClassNameProp & React.ComponentPropsWithoutRef<typeof TabsPrimitive.Trigger>
>(({ className, ...props }, ref) => (
...
const TabsContent = React.forwardRef<
  ...
  ClassNameProp & React.ComponentPropsWithoutRef<typeof TabsPrimitive.Content>
>(({ className, ...props }, ref) => (
